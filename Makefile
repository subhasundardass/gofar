...
.PHONY: help run build tidy \
        module remove handler service repository \
...
help:
	...
	@printf "    make repository name=<Name> module=<Mod>  Add a repository to a module\n"
	@printf "\n"
	...
	@printf "    make repository name=Invoice module=Billing\n"
	@printf "\n"
...
ifndef name
	@printf "\n  \033[31merror:\033[0m name and module are required\n"
	@printf "  usage:  make repository name=<Name> module=<Module>\n"
	@printf "  example: make repository name=Invoice module=Billing\n\n"
	@exit 1
endif
ifndef module
	@printf "\n  \033[31merror:\033[0m module is required\n"
	...
	@$(CLI) make:repository name=$(name) module=$(module)
