...
const (
	// Label holds the string label denoting the acct_group type in the database.
	Label = "acct_group"
	...
	EdgeLedgers = "ledgers"
	// Table holds the table name of the acct_group in the database.
	Table = "acct_groups"
	// ChildrenTable is the table that holds the children relation/edge.
	ChildrenTable = "acct_groups"
	// ChildrenColumn is the table column denoting the children relation/edge.
	ChildrenColumn = "acct_group_parent"
	// ParentTable is the table that holds the parent relation/edge.
	ParentTable = "acct_groups"
	// ParentColumn is the table column denoting the parent relation/edge.
	ParentColumn = "acct_group_parent"
	...
	LedgersColumn = "acct_group_ledgers"
)

// Columns holds all SQL columns for acct_group fields.
var Columns = []string{
	FieldID,
	FieldCode,
	FieldName,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "acct_groups"
...
func NatureValidator(n Nature) error {
	...
	case NatureASSET, NatureLIABILITY, NatureEQUITY, NatureINCOME, NatureEXPENSE:
		return nil
	default:
		return fmt.Errorf("acct_group: invalid enum value for nature field: %q", n)
	}
}

// OrderOption defines the ordering options for the Acct_Group queries.
