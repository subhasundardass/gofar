...
func (_q *LedgerQuery) QueryGroup() *AcctGroupQuery {
...
func (_q *LedgerQuery) WithGroup(opts ...func(*AcctGroupQuery)) *LedgerQuery {
	query := (&AcctGroupClient{config: _q.config}).Query()
...
func (_q *LedgerQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Ledger, error) {
	...
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *Ledger, e *Acct_Group) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *LedgerQuery) loadGroup(ctx context.Context, query *AcctGroupQuery, nodes []*Ledger, init func(*Ledger), assign func(*Ledger, *Acct_Group)) error {
