...
func (_q *CountryQuery) QueryStates() *StateQuery {
...
func (_q *CountryQuery) WithStates(opts ...func(*StateQuery)) *CountryQuery {
	query := (&StateClient{config: _q.config}).Query()
...
func (_q *CountryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Country, error) {
	...
	if query := _q.withStates; query != nil {
		if err := _q.loadStates(ctx, query, nodes,
			func(n *Country) { n.Edges.States = []*State{} },
			func(n *Country, e *State) { n.Edges.States = append(n.Edges.States, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *CountryQuery) loadStates(ctx context.Context, query *StateQuery, nodes []*Country, init func(*Country), assign func(*Country, *State)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(state.FieldCountryID)
	}
	query.Where(predicate.State(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(country.StatesColumn), fks...))
	}))
