...
// The Acct_GroupFunc type is an adapter to allow the use of ordinary
// function as Acct_Group mutator.
type Acct_GroupFunc func(context.Context, *ent.AcctGroupMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Acct_GroupFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AcctGroupMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AcctGroupMutation", m)
}
...
// The Journal_LineFunc type is an adapter to allow the use of ordinary
// function as Journal_Line mutator.
type Journal_LineFunc func(context.Context, *ent.JournalLineMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Journal_LineFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
