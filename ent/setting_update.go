...
func (_u *SettingUpdate) SetGroup(v string) *SettingUpdate {
	_u.mutation.SetGroup(v)
	return _u
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (_u *SettingUpdate) SetNillableGroup(v *string) *SettingUpdate {
	if v != nil {
		_u.SetGroup(*v)
	}
	return _u
...
// SetGroup sets the "group" field.
func (_u *SettingUpdateOne) SetGroup(v string) *SettingUpdateOne {
	_u.mutation.SetGroup(v)
	return _u
}

// SetNillableGroup sets the "group" field if the given value is not nil.
func (_u *SettingUpdateOne) SetNillableGroup(v *string) *SettingUpdateOne {
	if v != nil {
		_u.SetGroup(*v)
	}
	return _u
