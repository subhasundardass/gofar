...
func (tx *Tx) init() {
	tx.Acct_Group = NewAcctGroupClient(tx.config)
	tx.Country = NewCountryClient(tx.config)
	tx.Journal = NewJournalClient(tx.config)
...
// applies a query, for example: Acct_Group.QueryXXX(), the query will be executed
